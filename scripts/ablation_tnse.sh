# exp 1
CUDA_VISIBLE_DEVICES=1,2 python main_tsne.py \
--log_dir ./log_ablation_tsne/log_exp1 \
...
# exp 2
CUDA_VISIBLE_DEVICES=0,1 python main_tsne.py \
--log_dir ./log_ablation_tsne/log_exp2 \
--data_dir /mnt/nfsdisk/jier/4_MANN/mann_hdv/data \
--input_channel 1 \
--feature_dim 512 \
--class_num 20 \
...
# exp 3
CUDA_VISIBLE_DEVICES=0,1 python main_tsne.py \
--log_dir ./log_ablation_tsne/log_exp3 \
--data_dir /mnt/nfsdisk/jier/4_MANN/mann_hdv/data \
--input_channel 1 \
--feature_dim 512 \
--class_num 20 \
...
# exp 4
CUDA_VISIBLE_DEVICES=0,1 python main_tsne.py \
--log_dir ./log_ablation_tsne/log_exp4 \
--data_dir /mnt/nfsdisk/jier/4_MANN/mann_hdv/data \
--input_channel 1 \
--feature_dim 512 \
--class_num 20 \
...
# exp 5
CUDA_VISIBLE_DEVICES=0,1 python main_tsne.py \
--log_dir ./log_ablation_tsne/log_exp5 \
--data_dir /mnt/nfsdisk/jier/4_MANN/mann_hdv/data \
--input_channel 1 \
--feature_dim 512 \
--class_num 20 \
...
# exp 6
CUDA_VISIBLE_DEVICES=0,1 python main_tsne.py \
--log_dir ./log_ablation_tsne/log_exp6 \
--data_dir /mnt/nfsdisk/jier/4_MANN/mann_hdv/data \
--input_channel 1 \
--feature_dim 512 \
--class_num 20 \
...
# exp 7
CUDA_VISIBLE_DEVICES=0,1 python main_RBNN_tsne.py \
--log_dir ./log_ablation_tsne/log_exp7 \
--data_dir /mnt/nfsdisk/jier/4_MANN/mann_hdv/data \
--input_channel 1 \
--feature_dim 512 \
--class_num 20 \
...
# exp 8
CUDA_VISIBLE_DEVICES=0,1 python main_RBNN_tsne.py \
--log_dir ./log_ablation_tsne/log_exp8 \
--data_dir /mnt/nfsdisk/jier/4_MANN/mann_hdv/data \
--input_channel 1 \
--feature_dim 512 \
--class_num 20 \
